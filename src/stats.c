 ...
 */
void compute_stats() {
    double total = stats.accesses * MEMORY_ACCESS_TIME + stats.writebacks * DISK_PAGE_WRITE_TIME + stats.page_faults * DISK_PAGE_READ_TIME;
    stats.amat = total / (stats.accesses);
}
